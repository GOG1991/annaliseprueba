...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'applicants.city'
        db.add_column(u'annalise_job_applicants', 'city',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['annalise_investors.Ciudad'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'applicants.city'
        db.delete_column(u'annalise_job_applicants', 'city_id')
